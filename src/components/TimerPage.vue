  ...
  <div class="flex flex-col h-screen w-full bg-priamry">
    ...
    <div class="w-full h-full flex items-start justify-center">
      <div class="bg-white min-h-60 min-w-96 max-w-6xl py-5 md:py-6 lg:py-7 h-auto w-7/12 rounded-2xl flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-5">
        ...
        <div class="w-8/12 h-auto py-4 sm:py-5 md:py-6 lg:py-7 bg-timer-bg rounded-2xl border-priamry border-4 md:border-[5px] flex items-center justify-center">
          <div class="text-7xl sm:text-8xl md:text-9xl text-timer-number font-['DS-Digital']">88.88</div>
          <div class="text-7xl sm:text-8xl md:text-9xl text-priamry -ml-[159.5px] sm:-ml-[212.8px] md:-ml-[283.5px] font-['DS-Digital']">02.37</div>
        </div>
