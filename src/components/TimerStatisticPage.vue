      ...
      <div class="w-full h-auto bg-white pt-10 pb-3">
        ...
        <div v-for="(user, index) in currentPageData" key="user.quizRankId">
          <div class="flex pb-4 md:pb-7">
            <div class="w-3/12 min-w-10 flex justify-end px-4 sm:px-8 md:px-10 lg:px-14 xl:px-20 text-light-purple text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold items-center">{{ startIndex + index + 1 }}</div>
