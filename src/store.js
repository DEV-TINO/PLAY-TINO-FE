...
export default createStore({
  ...
  mutations: {
    ...
    updateFavoriteImagePairs(state, selectedPairs) {
      state.favoriteImagePairs = ''
      state.favoriteImagePairs = selectedPairs
    },
  ...
  actions: {
    ...
    generateImagePairs(context) {
      for (let i = 0; i < context.state.favoriteList.length; i += 2) {
        ...
        context.state.favoriteImagePairs.push(pair)
      }
    },
